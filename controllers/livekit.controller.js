...
exports.generateToken = async (req, res) => {
  ...
  // 👇 Generate unique identity for LiveKit
  const uniqueIdentity = `${identity}-${uuidv4()}`;
  ...
  res.json({
    token,
    identity: uniqueIdentity,  // internal LiveKit identity
    displayName: identity,     // clean for frontend display
  });
};
